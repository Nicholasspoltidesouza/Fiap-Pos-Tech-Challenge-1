...
class VeiculoDataMapperTest {
    ...
    void shouldMapRequestToEntity() {
        ...
        VeiculoRequestDTO request = new VeiculoRequestDTO("Toyota", "Corolla", 2020, clienteId);
    ...
    void shouldUpdateEntityFromRequest() {
        ...
        VeiculoRequestDTO request = new VeiculoRequestDTO("Chevrolet", "Onix", 2022, newClienteId);
